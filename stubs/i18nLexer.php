...
class i18nLexer {
	...
	public $position;
	public $positions;
	public $currentVarBlockLine;
	public array $openingBrackets = [ '{', '(', '[' ];
	public array $closingBrackets = [ '}', ')', ']' ];
	...
	public function lexExpression(): void {
		// whitespace
	...
	public function stripcslashes( string $str, string $quoteType ): string {
		$result = '';
		$length = \strlen( $str );
	...
	public function lexRawData(): void {
	...
	public function lexString(): void {
	...
	public function lexInterpolation(): void {
	...
	public function pushToken( $type, $value = '' ): void {
	...
	public function moveCursor( $text ): void {
	...
	public function checkBrackets( string $code ): void {
		// opening bracket
